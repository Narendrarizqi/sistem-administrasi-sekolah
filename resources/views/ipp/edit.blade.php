...
@section('title', 'Edit Tagihan IPP')
...
@section('content')
    ...
    <div class="card shadow-sm border-0" style="border-radius: 12px; overflow: hidden;">
        ...
        <div class="card-body p-4">
            ...
            <form action="{{ route('ipp.update', $pembayaran->id) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <small class="form-text text-muted">
                        Tarif per bulan otomatis = Target / 12 (Rp {{ number_format($pembayaran->target / 12, 0, ',', '.') }}/bulan).
                    </small>
