    ...
    <div class="page-header-box">
        <div>
            <div class="page-header-breadcrumb">
                ...
                <span class="text-dark font-weight-bold">Kegiatan Intrakurikuler</span>
            </div>
            <h1 class="page-header-title">
                <span class="page-header-icon"><i class="fas fa-book-open"></i></span>
                Kegiatan Intrakurikuler (KI)
            </h1>
            <p class="page-header-desc">
                Kelola data tagihan program & kegiatan intrakurikuler siswa, riwayat pembayaran, serta status pelunasan.
            </p>
        </div>
    ...
    <div class="card shadow-sm border-0">
        ...
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
                ...
                <div class="d-flex align-items-center gap-2 flex-wrap">
                    ...
                    @if(isset($daftarTahunAjaran) && $daftarTahunAjaran->isNotEmpty())
                        <form action="{{ route('ki.index') }}" method="GET" class="d-flex align-items-center">
                            <select
                ...
                <button type="button" class="btn btn-add" data-toggle="modal" data-target="#modalTambahKi">
            ...
            <div class="table-responsive">
                ...
                <table class="table table-hover align-middle" id="kiTable">
            ...
            <div class="modal-content border-0 shadow">
                ...
                <form action="{{ route('ki.store') }}" method="POST" id="formModalTambahKi">
                    ...
                    <div class="modal-body p-4">
                        ...
                        <div id="modalKiDuplicateAlert" class="alert alert-danger d-none mb-3 py-2 px-3">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-sm-9">
                                ...
                                <div id="modalKiSelectedSiswaBox" class="mt-2 p-2 bg-light border rounded small d-none">
                        ...
                        {{-- Target Nominal --}}
                        <div class="form-group row mb-3">
                            <label for="modal_ki_target" class="col-sm-3 col-form-label font-weight-bold">
                            ...
                            <div class="col-sm-9">
                                ...
                                <small class="form-text text-muted">
                                    Total kewajiban tagihan Kegiatan Intrakurikuler untuk siswa pada tahun ajaran ini.
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="fee-info-box my-3">
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    <div class="font-weight-bold text-success" style="font-size: 18px;" id="modalKiSummaryTotalLabel">
                                        Rp 0
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="modal-footer bg-light py-2">
                        ...
                        <button type="submit" id="btnSubmitTambahKi" class="btn btn-success px-4 font-weight-bold">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content border-0 shadow">
                    ...
                    <div class="modal-body">
                        <p class="mb-2">
                            Apakah Anda yakin ingin menghapus tagihan Kegiatan Intrakurikuler untuk siswa <strong>{{ $item->siswa->nama ?? '-' }}</strong>?
                        </p>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content border-0 shadow">
                    ...
                    <div class="modal-body text-center py-4">
                        ...
                        <h5>Pembayaran KI berhasil dicatat!</h5>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const modalKiTargetInput = document.getElementById('modal_ki_target');
    ...
    if (modalKiTargetInput && modalKiSummaryTotalLabel) {
        modalKiTargetInput.addEventListener('input', function () {
            const val = parseFloat(this.value) || 0;
            modalKiSummaryTotalLabel.textContent = `Rp ${formatRupiah(val)}`;
        });
    }
});
</script>
