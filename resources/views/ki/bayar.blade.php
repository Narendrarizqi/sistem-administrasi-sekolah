        ...
        <div class="card shadow-sm border-0 mb-4">
            ...
            <form method="POST" action="{{ route('ki.bayar', $pembayaran->id) }}" enctype="multipart/form-data">
                ...
                <div class="card-body p-4">
                        ...
                        <div class="col-sm-9">
                            <div class="custom-file-upload">
                                <input type="file"
                                       ...
                                       accept="image/*,.pdf"
                                       onchange="if(this.files && this.files[0]) { document.getElementById('labelBuktiKiPage').innerHTML = '<i class=\'fas fa-file text-success mr-2\'></i><span class=\'font-weight-bold text-dark\'>' + this.files[0].name + '</span>'; }">
                                <label for="buktiKiPage" class="file-upload-label d-flex align-items-center justify-content-between px-3">
                                    <span id="labelBuktiKiPage" class="text-muted text-truncate" style="max-width: 78%; font-size: 13px;">
                    ...
                    <div class="d-flex justify-content-between pt-2 border-top">
                        <a href="{{ route('ki.index') }}" class="btn btn-secondary px-4">
