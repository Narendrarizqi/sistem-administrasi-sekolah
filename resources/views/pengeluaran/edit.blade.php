                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        >
                            ...
                            <option value="IPP" {{ old('sumber_dana', $pengeluaran->sumber_dana) === 'IPP' ? 'selected' : '' }}>IPP (Iuran Pembayaran Pendidikan)</option>
                            ...
                            <option value="KI" {{ old('sumber_dana', $pengeluaran->sumber_dana) === 'KI' ? 'selected' : '' }}>Asesmen</option>
                            <option value="Ekstrakurikuler" {{ old('sumber_dana', $pengeluaran->sumber_dana) === 'Ekstrakurikuler' ? 'selected' : '' }}>Ekstrakurikuler</option>
                            <option value="Kokurikuler" {{ old('sumber_dana', $pengeluaran->sumber_dana) === 'Kokurikuler' ? 'selected' : '' }}>Kokurikuler</option>
                ...
                <div class="form-group mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input
                            ...
                            value="{{ old('nominal', (int)$pengeluaran->nominal) }}"
                            min="1"
                            step="1"
