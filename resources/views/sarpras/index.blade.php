    ...
    <div class="page-header-box">
        <div>
            <div class="page-header-breadcrumb">
                ...
                <span class="text-dark font-weight-bold">Sarana & Prasarana</span>
            </div>
            ...
            <p class="page-header-desc">
                Kelola data tagihan iuran sarana & fasilitas sekolah, pencatatan transaksi masuk, serta status pelunasan siswa.
            </p>
        </div>
    ...
    <div class="card shadow-sm border-0">
        ...
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
                ...
                <div class="d-flex align-items-center gap-2 flex-wrap">
                    ...
                    @if(isset($daftarTahunAjaran) && $daftarTahunAjaran->isNotEmpty())
                        <form action="{{ route('sarpras.index') }}" method="GET" class="d-flex align-items-center">
                            <select
                ...
                <button type="button" class="btn btn-add" data-toggle="modal" data-target="#modalTambahSarpras">
            ...
            <div class="table-responsive">
                ...
                <table class="table table-hover align-middle" id="sarprasTable">
            ...
            <div class="modal-content border-0 shadow">
                ...
                <form action="{{ route('sarpras.store') }}" method="POST" id="formModalTambahSarpras">
                    ...
                    <div class="modal-body p-4">
                        ...
                        <div id="modalSarprasDuplicateAlert" class="alert alert-danger d-none mb-3 py-2 px-3">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-sm-9">
                                ...
                                <div id="modalSarprasSelectedSiswaBox" class="mt-2 p-2 bg-light border rounded small d-none">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-sm-9">
                                ...
                                <small class="form-text text-muted">
                                    Total kewajiban tagihan Sarana & Prasarana untuk siswa pada tahun ajaran ini.
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="fee-info-box my-3">
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    <div class="font-weight-bold text-success" style="font-size: 18px;" id="modalSarprasSummaryTotalLabel">
                                        Rp 0
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="modal-footer bg-light py-2">
                        ...
                        <button type="submit" id="btnSubmitTambahSarpras" class="btn btn-success px-4 font-weight-bold">
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content border-0 shadow">
                    <div class="modal-header modal-header-payment py-3">
                        <h5 class="modal-title font-weight-bold" style="font-size: 16px;">
                            <i class="fas fa-tools mr-2"></i>
                            Pembayaran Sarpras: {{ $item->siswa->nama ?? '-' }} ({{ $item->siswa->nis ?? '-' }})
                        </h5>
                        <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <div class="custom-file-upload">
                                        ...
                                        <label for="buktiSarpras{{ $item->id }}" class="file-upload-label d-flex align-items-center justify-content-between px-3">
                                            <span id="labelBuktiSarpras{{ $item->id }}" class="text-muted text-truncate" style="max-width: 78%; font-size: 13px;">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content border-0 shadow">
                    ...
                    <div class="modal-body">
                        <p class="mb-2">
                            Apakah Anda yakin ingin menghapus tagihan Sarpras untuk siswa <strong>{{ $item->siswa->nama ?? '-' }}</strong>?
                        </p>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content border-0 shadow">
                    ...
                    <div class="modal-footer justify-content-center">
                        <button type="button" class="btn btn-tutup-merah px-4 mr-2" data-dismiss="modal">Tutup</button>
