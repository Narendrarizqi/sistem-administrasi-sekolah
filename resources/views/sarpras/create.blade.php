...
@section('title', 'Tambah Tagihan Sarpras')
                    ...
                    <form action="{{ route('sarpras.store') }}" method="POST">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                ...
                                @enderror
                                <small class="text-muted">Total target biaya Sarpras yang harus dibayarkan.</small>
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-between align-items-center pt-3 border-top">
                            <a href="{{ route('sarpras.index') }}" class="btn btn-secondary px-3">
                                <i class="fas fa-arrow-left mr-1"></i>
                                Kembali
                            </a>

                            <button type="submit" id="btnSubmitSarpras" class="btn btn-success px-4 font-weight-bold">
...
@section('js')
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const submitBtn = document.getElementById('btnSubmitSarpras');
